...
const SendCampaign = () => {
  ...
  const saveOrUpdateTopMessage = () => {
    Inertia.post(
      route('send.campaign.top.message'),
      ...
      <div className="max-w-4xl mx-auto mt-8">
        ...
        <div className="mt-8 p-10 bg-white shadow-sm rounded">
          <form className="space-y-5" onSubmit={submit}>
            ...
            <div>
              <label htmlFor="subject" className="block text-sm mb-1 font-medium">
                Subject
              </label>
              <Input
                type="text"
            ...
            <div>
              <label htmlFor="top_message" className="block text-sm mb-1 font-medium">
                Message
              </label>
              <Input.TextArea
                id="top_message"
            ...
            <div key={index}>
              ...
              <div className="pl-2">
                ...
                {campaign.length_url && (
                  <p
                    dangerouslySetInnerHTML={{
                      __html: campaign.length_url.replace(/\n/g, '<br />'),
                    }}
                  />
                )}
              </div>
