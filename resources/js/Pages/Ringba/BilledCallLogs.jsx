...
import { Button, makeStyles, CircularProgress, TextField } from '@material-ui/core';
...
const BilledCallLogs = () => {
  ...
  const [filteredData, setFilteredData] = useState(filterData(billedCallLogs, filterValue));
