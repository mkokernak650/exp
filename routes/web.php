...
Route::middleware('auth')->group(function () {
    ...
    Route::get('ecommerce-campaigns-affiliates/export/{campaignId}', [EcommerceCampaignController::class, 'affiliateListExport'])->name('ecommerce.campaigns.affiliates.export');
    ...
    Route::post('insertion-order/cash-buy/check-slot', [InsertionOrderController::class, 'cashBuyCheckSlot'])->name('insertion.order.cash.buy.check.slot');
    ...
    Route::post('send-campaign-top-message', [SendCampaignController::class, 'topMessage'])->name('send.campaign.top.message');
});
